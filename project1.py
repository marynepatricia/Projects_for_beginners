...
print('='*30)
print(f"\033[33mWELCOME TO MY QUIZ GAME...\033[m")
print('='*30)
...
sleep(1)
question1 = input(f"What is the best TV series ever? ").upper()
...
if cont != 'Y':
    ...
    question2 = input(f'What is my favorite food? ').upper()
    while question2 != 'SUSHI':
        print(f'\033[31mTry again !!\033[m')
        question2 = input(f'What is my favorite food? ').upper()
    cont = input("\033[32mGOOD!!! Would you like to continue? \033[m").upper()[0]
    if cont != 'Y':
        print('Ok, see you next time...')
        ...
        while question3 != 'PASCAL':
            print(f'\033[31m Try again !!\033[m')
            question3 = input('What was the first programming language I learned? ').upper()
        cont = input("\033[32mGOOD!!! Would you like to continue? \033[m").upper()[0]
        if cont != 'Y':
            print('Ok, see you next time...')
        else:
            question4 = input('What was the second programming language I learned? ').upper()
